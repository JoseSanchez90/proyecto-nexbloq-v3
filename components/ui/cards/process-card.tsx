...
export default function ProcessCard({
  ...
  return (
    <article
      className={cn(
        "group relative isolate overflow-hidden rounded-2xl border border-zinc-200 bg-white p-3",
        className,
      )}
    >
      <span
      ...
      <div className="relative z-10 aspect-[16/10] overflow-hidden rounded-xl border border-zinc-200 bg-zinc-100">
        <Image
          src={image}
          alt={`Referencia visual de la etapa ${title}`}
          fill
      ...
      <div className="relative z-10 flex min-h-52 flex-col justify-between px-3 pb-3 pt-5">
        <div className="flex items-center justify-between">
          <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#5635ff]/10 text-[#5635ff] transition-colors duration-500 group-hover:bg-white group-hover:text-[#5635ff]">
